...
- 33c85c8: Fill a workspace created with example content: five channels beside the two chat already makes, a
  ...
  `core.workspace.created` — so a channel is _found or made_, never assumed either way: the two events
